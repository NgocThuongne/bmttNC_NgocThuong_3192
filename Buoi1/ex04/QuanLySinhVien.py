...
class QuanLySinhVien:
    ...
    def nhapSinhVien(self):
        ...
        diemTB = float(input("Nhao diem cuar sinh vien: "))
    ...
    def updateSinhVien(self, ID):
        ...
        if(sv !=None):
            name = input("Nhap ten sinh vien: ")
            sex = input("Nhap gioi tinh sinh vien: ")
            major = int(input("Nhap chuyen nganhf cuar sinh vien: "))
            ...
            print("Sinh vien cos ID = {} khong ton tai.".format(ID))
    ...
    def deleteById(self, ID) :
        isDeleted = Falsesv = self.findByID(ID)
        if(sv != None):
